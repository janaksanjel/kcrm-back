...
from . import views
from .store_views import store_config, check_availability
...
urlpatterns = [
    ...
    # Store configuration
    path('settings/store-config/', store_config, name='store_config'),
    path('settings/check-availability/', check_availability, name='check_availability'),
]